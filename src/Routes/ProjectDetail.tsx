    ...
    <main className="project-detail">
      ...
      <div className="project-detail__bottom">
       ...
       <button onClick={goBack} className="project-detail__button">
        ...
        <h2 className="project-detail__heading heading">{projectToRender?.name}</h2>
        ...
        <div className="project-detail__links">
          <a target="_blank" rel="noopener noreferrer" href={projectToRender?.url} className="project-detail__link btn-style-v1" >Visitar sitio</a>
          <a target="_blank" rel="noopener noreferrer" href={projectToRender?.github} className="project-detail__link btn-style-v1">Visitar repositorio</a>
        </div>
       </div>
      </div>
         </main>
